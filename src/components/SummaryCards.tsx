...
export default function SummaryCards({ years, monthlyPremium, monthlyTermPremium, totals }: Props) {
  ...
  return (
    <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-1">
      ...
      <div className="bg-neutral-900 border border-neutral-800 rounded-2xl p-4 sm:p-5">
        <div className="text-sm text-neutral-400">Term Premiums Paid</div>
        <div className="text-2xl font-semibold">{currency(monthlyTermPremium * years * 12)}</div>
        <div className="text-xs text-neutral-500 mt-1">
          {years} years × {currency(monthlyTermPremium)} / month
        </div>
      </div>
      <div className="bg-neutral-900 border border-neutral-800 rounded-2xl p-4 sm:p-5">
